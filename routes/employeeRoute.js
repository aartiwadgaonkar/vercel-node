const { registerEmployee, getAllEmployees, getSingleEmployees, updateEmployees, deleteEmployees, destroyEmployees, getEmployeeProfile, adminGetAllProducts, adminGetAllUsers, adminUserStatus, adminStat } = require("../controllers/employeeController")
